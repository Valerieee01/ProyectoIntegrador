...
public class BotonEditor extends DefaultCellEditor {
    ...
    private final PrestamosPane panelPadre; // referencia al panel padre

    public BotonEditor(JCheckBox checkBox, PrestamosPane prestamosPane) {
        super(checkBox);
        this.panelPadre = prestamosPane; // guardar la referencia
        ...
        btnEditar.addActionListener(e -> {
            ...
            if (table != null) {
                ...
                prestamosPane.editarPrestamo(idPrestamo, row); // llamar método del panel
            }
            fireEditingStopped();
        });
        ...
        btnEliminar.addActionListener(e -> {
            ...
            if (table != null) {
                int row = table.getEditingRow();
                Long idPrestamo = Long.parseLong(table.getValueAt(row, 0).toString());
                prestamosPane.eliminarPrestamo(idPrestamo); // llamar método del panel
            }
            fireEditingStopped();
        });
    }
